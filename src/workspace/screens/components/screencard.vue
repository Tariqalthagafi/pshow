...
import ScreenLinkSection from "./LinkSection.vue"
import ScreenOfferSection from "./OfferSection.vue"
import ScreenInfoSection from "./InfoSection.vue"
import type { Screen, Offer } from "@/workspace/screens/types/screen.types"

const props = defineProps<{
  screen: Screen
  locked: boolean
  openScreenId: number | null
  models: Offer[]
}>()
